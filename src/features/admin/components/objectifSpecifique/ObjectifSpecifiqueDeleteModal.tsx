...
interface ObjectifSpecifiqueDeleteModalProps {
...
export const ObjectifSpecifiqueDeleteModal: React.FC<ObjectifSpecifiqueDeleteModalProps> = ({ item, isDeleting, onConfirm, onCancel }) => {
    return (
        <div
        ...
        >
            <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-sm animate-fade-in">
                <div className="px-8 py-6 space-y-4">
                    ...
                    <div>
                        <h2 className="text-base font-bold text-slate-900 tracking-tight">Supprimer l'objectif</h2>
